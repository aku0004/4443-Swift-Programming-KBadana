...
class CurrentLocationViewController: UIViewController, CLLocationManagerDelegate {
    ...
    func updateLabels(){
        ...
        PostnVal.LatVal=location!.coordinate.latitude
        PostnVal.LngVal=location!.coordinate.longitude
    ...
    /*override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        var secondVC:SecondViewController=segue.destinationViewController as SecondViewController
            ...
            println(location!.coordinate.latitude)
            println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
        secondVC.latVal=location!.coordinate.latitude
        secondVC.lngVal=location!.coordinate.longitude
